            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "newest",
                        "description": "排序方式: newest, hot, weight",
                        "name": "order_by",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/works/{id}/status": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "状态: 0草稿 1已发布 2审核中 3未通过 4下架",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
